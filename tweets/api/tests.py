...
class TweetApiTests(TestCase):
    ...
    def test_list_api(self):
        ...
        n = len(self.tweets2)
        for i in range(n):
            self.assertEqual(response.data['results'][i]['id'], self.tweets2[n - i - 1].id)
    ...
    def test_create_with_files(self):
        ...
        # upload single file
        # content is a type of bytes,so we use str.encode to convert
        ...
        # API has the url address for the photos
        ...
        # fail to upload more then 9 pictures
        files = [
            SimpleUploadedFile(
                name=f'selfie{i}.jpg',
    ...
    def test_retrieve(self):
        ...
        # retrieve a tweet with its comments
        ...
        # tweet includes profile picture and nickname
