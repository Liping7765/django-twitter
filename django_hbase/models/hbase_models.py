...
class HBaseModel:
    ...
    def save(self):
        ...
        #if row_data is empty, column key values are empty, then no need to store data
        if len(row_data) ==0:
    ...
    #arguments should be passed to filter as tuple().
    #For example, start = (user_id,created_at,)
    @classmethod
